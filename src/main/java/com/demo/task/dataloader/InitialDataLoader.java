package com.demo.task.dataloader;
...
import com.demo.task.service.RoleService;
...
public class InitialDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public InitialDataLoader(final UserService userService, final TaskService taskService, final RoleService roleService) {
    ...
    private String getOwnerNameOrNoOwner(final Task task) {
